...
#include "global_aerodynamics_plugin.h"

#include "Force.pb.h"

using namespace gazebo;

GZ_REGISTER_MODEL_PLUGIN(GlobalAerodynamicsPlugin)

/////////////////////////////////////////////////
GlobalAerodynamicsPlugin::GlobalAerodynamicsPlugin() : cla(1.0), cda(0.01), cma(0.0), rho(1.2041)
{
...
/////////////////////////////////////////////////
GlobalAerodynamicsPlugin::~GlobalAerodynamicsPlugin()
{
}

/////////////////////////////////////////////////
void GlobalAerodynamicsPlugin::Load(physics::ModelPtr _model,
                     sdf::ElementPtr _sdf)
{
  GZ_ASSERT(_model, "GlobalAerodynamicsPlugin _model pointer is NULL");
  GZ_ASSERT(_sdf, "GlobalAerodynamicsPlugin _sdf pointer is NULL");
  this->model = _model;
  this->sdf = _sdf;

  this->world = this->model->GetWorld();
  GZ_ASSERT(this->world, "GlobalAerodynamicsPlugin world pointer is NULL");
...
#endif
  GZ_ASSERT(this->physics, "GlobalAerodynamicsPlugin physics pointer is NULL");
  ...
  if (_sdf->HasElement("link_name"))
  {
    ...
    if (!this->link)
    {
      gzerr << "Link with name[" << linkName << "] not found. "
        << "The GlobalAerodynamicsPlugin will not generate forces\n";
    }
    else
    {
      this->updateConnection = event::Events::ConnectWorldUpdateBegin(
          boost::bind(&GlobalAerodynamicsPlugin::OnUpdate, this));
    }
  }
  ...
  if (_sdf->HasElement("windSubTopic")){
    ...
    wind_sub_ = node_handle_->Subscribe("~/" + wind_sub_topic_, &GlobalAerodynamicsPlugin::WindVelocityCallback, this);
  }
...
/////////////////////////////////////////////////
void GlobalAerodynamicsPlugin::OnUpdate()
{
  GZ_ASSERT(this->link, "Link was NULL");
...
void GlobalAerodynamicsPlugin::WindVelocityCallback(const boost::shared_ptr<const physics_msgs::msgs::Wind> &msg) {
