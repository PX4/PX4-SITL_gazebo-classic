...
class GAZEBO_VISIBLE GazeboGpsPlugin : public SensorPlugin {
public:
  GazeboGpsPlugin();
...
private:
  ...
  void activationCallback(const boost::shared_ptr<const msgs::Int> &request);
  void setBadGpsCallback(const boost::shared_ptr<const msgs::Int> &request);
  void activationGPSSpoofing(const boost::shared_ptr<const msgs::Int> &request);
  void enableDebugPrints(const boost::shared_ptr<const msgs::Int> &request);
  ...
  transport::SubscriberPtr activation_service_;
  transport::SubscriberPtr set_bad_gps_service_;
  transport::SubscriberPtr activation_spoof_service_;
  transport::SubscriberPtr debug_service_;
...
};  // class GAZEBO_VISIBLE GazeboGpsPlugin
}  // namespace gazebo
