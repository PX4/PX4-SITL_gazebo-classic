...
class GazeboSwashplatePlugin : public MotorModel, public ModelPlugin {
 public:
  GazeboSwashplatePlugin()
      : ModelPlugin(),
        MotorModel(),
  ...
  virtual ~GazeboSwashplatePlugin();
 ...
 private:
  ...
  double ref_cyclic_command_{0.0};
  double ref_pitch_command_{0.0};
  double ref_roll_command_{0.0};
