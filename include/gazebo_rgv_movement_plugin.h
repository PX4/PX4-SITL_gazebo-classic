 ...
 *
*/
#ifndef _GAZEBO_RGVMOVEMENT_PLUGIN_HH_
#define _GAZEBO_RGVMOVEMENT_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE RgvMovementPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: RgvMovementPlugin();
    ...
    private: 
      RgvMovementPluginPrivate *dataPtr;
      int _idx = 0; 
  };
}
#endif
