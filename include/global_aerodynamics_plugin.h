 ...
 *
*/
#ifndef _GLOBAL_AERODYNAMICS_PLUGIN_HH_
#define _GLOBAL_AERODYNAMICS_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE GlobalAerodynamicsPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: GlobalAerodynamicsPlugin();
